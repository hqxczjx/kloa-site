...
import { AGNES_BASE_URL, CHAT_MODEL, RATE_LIMIT_WINDOW_SEC, MAX_INPUT_CHARS, DEFAULT_CHARACTER_IMAGE_URL, RATIO_FRAMES } from '../../../worker/_lib/config';
...
describe('config', () => {
  ...
  it('限流窗口与字数阈值为正数', () => {
    expect(RATE_LIMIT_WINDOW_SEC).toBeGreaterThan(0);
